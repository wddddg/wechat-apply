  ...
  return {
    ...
    x: common_vendor.f($data.swipeList, (item, index, i0) => {
      return {
        ...
        e: "76d71bba-14-" + i0 + ",76d71bba-13",
        f: common_vendor.p({
          ["right-options"]: item.options
        })
      };
    }),
    y: common_vendor.sr("swipeAction", "76d71bba-13")
  };
}
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "D:/code/wechat-apply/wechat-apply/pages/extUI/swipe-action/swipe-action.vue"]]);
