...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    b: common_vendor.f(4, (item, index, i0) => {
      return {
        a: "52d8e13b-4-" + i0 + "," + ("52d8e13b-3-" + i0),
        b: index,
        c: "52d8e13b-3-" + i0 + ",52d8e13b-2",
        d: common_vendor.p({
          index
        })
      };
    ...
    g: common_vendor.f(8, (item, index, i0) => {
      return {
        a: "52d8e13b-8-" + i0 + "," + ("52d8e13b-7-" + i0),
        b: index,
        c: "52d8e13b-7-" + i0 + ",52d8e13b-6",
        d: common_vendor.p({
          index
        })
      };
    ...
    D: common_vendor.f($data.list, (item, index, i0) => {
      return common_vendor.e({
        ...
        d: "52d8e13b-22-" + i0 + "," + ("52d8e13b-21-" + i0),
        e: common_vendor.p({
          text: item.badge,
          type: item.type
        })
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "D:/code/wechat-apply/wechat-apply/pages/extUI/grid/grid.nvue"]]);
