  ...
  return {
    ...
    e: common_vendor.f($data.tableData, (item, index, i0) => {
      return {
        ...
        b: "31b22a21-7-" + i0 + "," + ("31b22a21-6-" + i0),
        c: common_vendor.t(item.name),
        d: "31b22a21-8-" + i0 + "," + ("31b22a21-6-" + i0),
        e: common_vendor.t(item.address),
        f: "31b22a21-9-" + i0 + "," + ("31b22a21-6-" + i0),
        g: "31b22a21-10-" + i0 + "," + ("31b22a21-6-" + i0),
        h: index,
        i: "31b22a21-6-" + i0 + ",31b22a21-0"
      };
    }),
    f: common_vendor.p({
      align: "center"
    }),
    g: common_vendor.sr("table", "31b22a21-0"),
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "D:/code/wechat-apply/wechat-apply/pages/extUI/table/table.vue"]]);
